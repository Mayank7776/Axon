...
from src.controllers import user_controller, role_controller, chat_controller, auth_controller, muscles_controller, myworkout_controller, blogs_controller, notification_controller
